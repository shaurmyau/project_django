...
![Главная страница аккаунта](screenshots/account.png)
*Обзор всех банковских карт и общий баланс пользователя*

### Управление транзакциями
![Управление транзакциями](screenshots/transactions.png)
*Список всех транзакций с фильтрацией по дате, типу и категории*

### Управление бюджетами
![Управление транзакциями](screenshots/budget.png)
*Управление бюджетами*

### Новости
![Управление транзакциями](screenshots/news.png)
*Новости*